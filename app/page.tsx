...
export default function HomePage() {
  return <main className="landing">
    ...
    <section className="coach-section" id="coach"><div className="coach-art"><Image src="/images/linan-ch2-v1.png" alt="女性站在城市分岔路线前的手绘场景" fill sizes="(max-width: 760px) 100vw, 46vw" /></div><div><p className="eyebrow">LIFE COACH 人生教练</p><h2>不说教，<br />也不替你决定</h2><p>Coach 只在每章结束后出现一次。它不诊断、不评价成功失败，也不说“你应该”。它会帮助你分开事实、情绪、资源、价值与代价，像一面受过训练的镜子。</p><blockquote>“这是恐惧替你作答，还是价值在发声？”</blockquote></div></section>
    ...
    <section className="atlas-section" id="atlas"><div><p className="eyebrow">YOUR ATLAS</p><h2>每条走过的路，<br />都会留在你的图鉴里</h2></div><Link className="primary" href="/collection">打开我的图鉴</Link></section>
  </main>;
}
